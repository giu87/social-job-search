/*
 * @(#)TwitterUser.java   1.0   19/apr/2012
 *
 ...
 * @(#) $Id$
 */
package it.expertfinding.datamodel.users.twitter;
...
public class TwitterUser extends TwitterResource {
   ...
   public String getResourceText() throws AlchemyLimitException {
      ...
      if (resourceText == null) {
         ...
         Facade.log.debug("Analyzing text of Twitter User id {}", get_id());
         ...
         for (String url : urls) {
            try {
               ...
               Facade.log.error("Limit reached while processing twitter user id: {}",
                     get_id());
               throw e;
            } catch (Exception e) {
               Facade.log.error("Error while processing twitter user id: " + get_id(), e);
            }
         }

...
public class PrecisionRecallExcelCalculatorDomains {
   ...
   private Set<String> usersInGroundTruth;

   public PrecisionRecallExcelCalculatorDomains(String method, String lan, List<Channel> cs,
   ...
   public void runTest() {
      ...
      for (Answer a : groundtruthUser.getAnswers()) {
         ...
         relevantDocuments = deleteUsersNotInGroundtruth(relevantDocuments,cs);
         ...
         List<String> bestUsersInGroundtruth = deleteUsersNotInGroundtruth((method
               .equals("textual")) ? q.getOrderedBestUserIds() : new ArrayList<String>(q
               .getBestUsersProb().keySet()), cs);
         ...
         // NDCG calculus
         List<Double> idealsNdcgs = idealZ(a.getQuestionId(), cs);
   ...
   private List<Double> idealZ(Integer queryId, List<Channel> cs) {
      ...
      while (cursor.hasNext()) {
         ...
         if(getUsersInGroundTruth(cs).contains(user.getUserId().toString())){
   ...
   private List<Double> ndcgOfQuery(List<String> bestUsersInGroundtruth,
   ...
   public List<String> deleteUsersNotInGroundtruth(List<String> users, List<Channel> cs){
      
      List<String> returnList = new ArrayList<String>();
      for(String user : users)
         if(getUsersInGroundTruth(cs).contains(user))
            returnList.add(user);
      return returnList;
   }
   
   public Set<String> deleteUsersNotInGroundtruth(Set<String> users, List<Channel> cs){
   ...
   public Set<String> getUsersInGroundTruth(List<Channel> cs){
   
      if(usersInGroundTruth != null)
         return usersInGroundTruth;

      Set<String> groundSet;
      if(cs.contains(Channel.TWITTER)){
         String[] channelList = {"4fb12ba3036487f167bbcc56", "4fb12ba3036487f167bbcc59", "4fb12ba3036487f167bbcc34",
            "4fb12ba3036487f167bbcc36","4fb12ba3036487f167bbcc6a","4fb12ba3036487f167bbcc4c","4fb12ba3036487f167bbcc3d",
            "4fb12ba3036487f167bbcc31","4fb12ba3036487f167bbcc30","4fb12ba3036487f167bbcc3f","4fb12ba3036487f167bbcc50",
            "4fb12ba3036487f167bbcc54","4fb12ba3036487f167bbcc55","4fb12ba3036487f167bbcc46","4fb12ba3036487f167bbcc69",
            "4fb12ba3036487f167bbcc5e","4fb12ba3036487f167bbcc3a","4fb12ba3036487f167bbcc2e","4fb12ba3036487f167bbcc2f",
            "4fb12ba3036487f167bbcc4e","4fb12ba3036487f167bbcc60","4fb12ba2036487f167bbcc2d","4fb12ba3036487f167bbcc42"};
         groundSet = new HashSet<String>(Arrays.asList(channelList));
      }
      else if(cs.contains(Channel.LINKEDIN)){
         String[] channelList = {"4fb12ba3036487f167bbcc56", "4fb12ba3036487f167bbcc59", "4fb12ba3036487f167bbcc58","4fb12ba3036487f167bbcc39",
               "4fb12ba3036487f167bbcc4b","4fb12ba3036487f167bbcc36","4fb12ba3036487f167bbcc6a","4fb12ba3036487f167bbcc4c","4fb12ba3036487f167bbcc3d",
               "4fb12ba3036487f167bbcc31","4fb12ba3036487f167bbcc30","4fb12ba3036487f167bbcc33","4fb12ba3036487f167bbcc3f",
               "4fb12ba3036487f167bbcc32","4fb12ba3036487f167bbcc54","4fb12ba3036487f167bbcc55","4fb12ba3036487f167bbcc46","4fb12ba3036487f167bbcc67",
               "4fb12ba3036487f167bbcc5e","4fb12ba3036487f167bbcc5c","4fb12ba3036487f167bbcc3a","4fb12ba3036487f167bbcc2e","4fb12ba3036487f167bbcc2f",
               "4fb12ba3036487f167bbcc4e","4fb12ba3036487f167bbcc61","4fb12ba3036487f167bbcc60","4fb12ba2036487f167bbcc2d","4fb12ba3036487f167bbcc42"};
         groundSet = new HashSet<String>(Arrays.asList(channelList));
      }
      else groundSet = new HashSet<String>();
      
      if(cs.size() == 0 || cs.contains(Channel.FACEBOOK)){
         DBCursor cursor = Facade.db.getCollection("groundtruth").find();
         while(cursor.hasNext()){
            Groundtruth user = Converter.toObject(Groundtruth.class, cursor.next());
            if(cs.size()==0)
               groundSet.add(user.getUserId().toString());
            else if(!user.getUserId().toString().equals("4fb12ba3036487f167bbcc3d"))
               groundSet.add(user.getUserId().toString());
         }
      }
      
      this.usersInGroundTruth = groundSet;
      return groundSet;
   }   
}